...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","bsGitBranch":"main","dynamicMsgBroker":true,"empty":"","nativeBuild":true,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","useCuratedAPIs":true,"appWorkloadURL":"http://where-for-dinner.eks.run.tap.ra.tapsme.org","artifactId":"where-for-dinner-eks","cacheType":"inmemCache","workloadType":"web","ployglotWorkloads":false,"artifactVersion":"0.0.1-beta","gatewayName":"gateway-where-for-dinner","bsGitRepository":"github.com?owner=rabeyta&repo=where-for-dinner-eks","dbType":"h2","enableSecurity":false,"numRabbitMQClusterNodes":1,"secureProfile":"secure","serviceNamespace":"eks","projectName":"where-for-dinner-eks","workloadNamespace":"eks","msgBrokerType":"rabbitmq"}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input15430372378153932955, --data-values-file, /tmp/accelerator-options11171358100092102531.json, --output-files, /tmp/ytt-output4525741898096799432]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","bsGitBranch":"main","dynamicMsgBroker":true,"empty":"","nativeBuild":true,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","useCuratedAPIs":true,"appWorkloadURL":"http://where-for-dinner.eks.run.tap.ra.tapsme.org","artifactId":"where-for-dinner-eks","cacheType":"inmemCache","workloadType":"web","ployglotWorkloads":false,"artifactVersion":"0.0.1-beta","gatewayName":"gateway-where-for-dinner","bsGitRepository":"github.com?owner=rabeyta&repo=where-for-dinner-eks","dbType":"h2","enableSecurity":false,"numRabbitMQClusterNodes":1,"secureProfile":"secure","serviceNamespace":"eks","projectName":"where-for-dinner-eks","workloadNamespace":"eks","msgBrokerType":"rabbitmq"}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input7848016700257941112, --data-values-file, /tmp/accelerator-options1278071392973963333.json, --output-files, /tmp/ytt-output39864989610546045]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","bsGitBranch":"main","dynamicMsgBroker":true,"empty":"","nativeBuild":true,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","useCuratedAPIs":true,"appWorkloadURL":"http://where-for-dinner.eks.run.tap.ra.tapsme.org","artifactId":"where-for-dinner-eks","cacheType":"inmemCache","workloadType":"web","ployglotWorkloads":false,"artifactVersion":"0.0.1-beta","gatewayName":"gateway-where-for-dinner","bsGitRepository":"github.com?owner=rabeyta&repo=where-for-dinner-eks","dbType":"h2","enableSecurity":false,"numRabbitMQClusterNodes":1,"secureProfile":"secure","serviceNamespace":"eks","projectName":"where-for-dinner-eks","workloadNamespace":"eks","msgBrokerType":"rabbitmq"}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input4430485750291957578, --data-values-file, /tmp/accelerator-options16830776121658482014.json, --output-files, /tmp/ytt-output10449499480786326522]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","bsGitBranch":"main","dynamicMsgBroker":true,"empty":"","nativeBuild":true,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","useCuratedAPIs":true,"appWorkloadURL":"http://where-for-dinner.eks.run.tap.ra.tapsme.org","artifactId":"where-for-dinner-eks","cacheType":"inmemCache","workloadType":"web","ployglotWorkloads":false,"artifactVersion":"0.0.1-beta","gatewayName":"gateway-where-for-dinner","bsGitRepository":"github.com?owner=rabeyta&repo=where-for-dinner-eks","dbType":"h2","enableSecurity":false,"numRabbitMQClusterNodes":1,"secureProfile":"secure","serviceNamespace":"eks","projectName":"where-for-dinner-eks","workloadNamespace":"eks","msgBrokerType":"rabbitmq"}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input1469405921062154553, --data-values-file, /tmp/accelerator-options17486474751645177587.json, --output-files, /tmp/ytt-output10349287022559830248]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=rabeyta&repo=where-for-dinner-eks'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"dynamicMsgBrokerClass":"rabbitmq-unmanaged","bsGitBranch":"main","dynamicMsgBroker":true,"empty":"","nativeBuild":true,"gatewayType":"tapscg","includeBuildToolWrapper":true,"msgbrokerName":"msgbroker-where-for-dinner","useCuratedAPIs":true,"appWorkloadURL":"http://where-for-dinner.eks.run.tap.ra.tapsme.org","artifactId":"where-for-dinner-eks","cacheType":"inmemCache","workloadType":"web","ployglotWorkloads":false,"artifactVersion":"0.0.1-beta","gatewayName":"gateway-where-for-dinner","bsGitRepository":"github.com?owner=rabeyta&repo=where-for-dinner-eks","dbType":"h2","enableSecurity":false,"numRabbitMQClusterNodes":1,"secureProfile":"secure","serviceNamespace":"eks","projectName":"where-for-dinner-eks","workloadNamespace":"eks","msgBrokerType":"rabbitmq"}
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input5431168924938737885, --data-values-file, /tmp/accelerator-options7908855155728764433.json, --output-files, /tmp/ytt-output4603365354717029645]
